...
public class GameClient {
    ...
    public static ClientConnectionPool<ThriftTestService.Client> ClientPool;
   
    
    public static synchronized ClientConnectionPool<ThriftTestService.Client> getClientPool() {
        return ClientPool;
    }
    ...
    public static synchronized boolean getIsDone() {
       return isDone;
    }
    public static synchronized void setIsDone(boolean done) {
       isDone = done;
    }
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            ClientPool = new ClientConnectionPool<ThriftTestService.Client>(ThriftTestService.Client.class);
            //Thread.sleep(2000);
